...
const messages = {
  'zh-CN': {
    common: {
      ...
      secureMode: '安全模式',
      compatMode: '兼容模式',
      compatModeTip: '开启后创建容器时删除机型包中的 cpuinfo 文件',
      dataDiskSize: '数据盘大小',
      ...
      expiredCannotStart: '已到期的云机无法开机/重启/重置，请先续费实例',
      ...
      vertical: '竖屏',
      horizontal: '横屏',
      projectionSettings: '投屏设置',
      gpuAcceleration: 'GPU 加速',
      gpuAccelerationDesc: '使用 D3D11VA 硬件解码（推荐）。关闭后走 CPU 软件解码，兼容性更好但 CPU 占用较高。',
      sidebarSwitch: '侧边栏',
      sidebarSwitchDesc: '默认打开（显示侧边栏）。关闭后禁用 WebView2 侧边栏，每窗口省约 900MB 内存，且自动消除左右黑边。批量投屏 50+ 窗口建议关闭。',
      autoGrantApkPermission: '安装APK自动授权',
      autoGrantApkPermissionDesc: '开启后，安装APK时自动授予所有运行时权限（相当于 pm install -g）。关闭后安装的APK需要手动在云机内授权。',
      projectionNotes: '注意事项',
      projectionNote1: '需要电脑有独立显卡或核显',
      projectionNote2: '请确认显卡驱动已正确安装且为最新版本，驱动异常可能导致画面异常',
      projectionNote3: '无 GPU 的电脑会自动使用软件解码，无需手动关闭',
      projectionNote4: '若出现闪屏、绿屏、花屏等画面异常，可尝试关闭后使用软件解码',
      projectionNote5: '软件解码兼容性更好，但 CPU 占用较高',
      projectionNote6: '切换后下次投屏生效',
      projectionSettingsSaved: '投屏设置已保存，下次投屏生效',
      projectionSettingsSaveFailed: '保存投屏设置失败',
      switching: '切换中...',
      running: '运行中',
      backupCount: '{count}备份',
      empty: '空',
      booting: '开机中...',
      shutdownClickBackup: '已关机 | 点击切换云机',
      pleaseRenewInstance: '请续费实例',
      emptySlot: '空坑位',
      switchBackupBtn: '切换',
      copy: '复制',
    ...
    backup: {
      ...
      importBtn: '导入',
      powerOnAfterImport: '是否开机',
      powerOnAfterImportTip: '导入完成后开机该云机；若所选坑位已有运行中的云机将先关机再开机',
      index: '序号',
      machineName: '云机名称',
      modelName: '机型名称',
  ...
  <ol style="margin: 0; padding-left: 20px;">
    ...
    network: {
      ...
      deleteGroupNode: '删除',
      directDomain: '直连域名',
      disableVpcBinding: '停用绑定',
      domainRuleDesc: '域名匹配规则',
      domainRules: '域名规则',
      editGroupAlias: '编辑别名',
      editNode: '编辑节点',
      enableVpcBinding: '启用绑定',
      filterDomain: '过滤域名',
      fullRuleDesc: '完整匹配规则',
      gateway: '网关',
      globalRules: '全局规则',
  ...
  <ul style="margin: 0; padding-left: 20px;">
    ...
    image: {
      ...
      resetFilter: '重置筛选',
      batchCreate: '批量创建',
      createFromLocal: '从本地镜像创建',
      createFromDevice: '从设备镜像创建',
      imageName: '镜像名称',
      imagePath: '镜像路径',
      imageURL: '镜像URL',
      size: '大小',
      createTime: '创建时间',
      refreshLocalImages: '刷新本地镜像',
      refreshDeviceImages: '刷新设备镜像',
      noLocalCacheImages: '暂无本地缓存镜像',
      noDeviceImages: '暂无设备镜像',
      downloadingImage: '正在下载镜像：',
      deviceImages: '设备镜像',
      deviceUpgrade: '设备升级',
      device: '设备',
      status: '状态',
  ...
  <ul style="padding-left: 20px; color: #606266; margin-bottom: 0;">
    ...
    extension: {
      ...
      mytAgent: 'MYT Agent',
      mytAgentDesc: '通过 AI 对话管理你的云手机设备',
      mytAgentSdkRequired: '要求 API 版本',
      mytAgentSdkCurrent: '当前 API 版本',
      mytAgentSdkNotMet: 'SDK 版本不满足要求，需 ≥ 177',
      deviceAuthRequired: '需要设备鉴权',
      devicePasswordPlaceholder: '请输入设备密码',
      mytAgentGuideIntro: 'MYT Agent 让你可以用自然语言与云手机设备对话，AI 自动执行相应操作。',
      mytAgentGuideReq: '安装要求：设备 SDK 版本必须 ≥ 165',
      mytAgentGuideStep1: '确认设备 SDK 版本 ≥ 165（左侧设备列表固件版本列可查看）',
      mytAgentGuideStep2: '点击"安装"按钮，系统将自动下载并安装 MYT Agent 到设备',
      mytAgentGuideStep3: '安装成功后，通过对话面板与设备交互即可',
      tunnel: '公网穿透',
    ...
    rpaAgent: {
      fetchModelFailed: '获取模型列表失败: ',
      loadContainerFailed: '加载容器列表失败: ',
      modelNotFound: '未找到模型',
      noLlmModel: '未配置LLM模型',
      stoppingOld: '正在停止旧实例...',
      startingWait: '正在启动，请稍候...',
      modelReady: '模型已就绪',
      startFailed: '启动失败: ',
      startTimeout: '启动超时',
      running: '运行中',
      ...
      stopped: '已停止',
      settingsSaved: '设置已保存',
      unconfiguredNodes: '以下设备未配置LLM模型:',
    },
  ...
  'en-US': {
    common: {
      ...
      compatModeTip: 'When enabled, the cpuinfo file in the model package is deleted during container creation',
      ...
      batchSwitchBackup: 'Batch Switch Cloud Machine',
      ...
      expiredCannotStart: 'Expired cloud machines cannot be started/restarted/reset. Please renew the instance first.',
      ...
      dragToSort: 'Drag to sort groups',
      ...
      gpuAccelerationDesc: 'Uses D3D11VA hardware decoding (recommended). When disabled, falls back to CPU software decoding — better compatibility but higher CPU usage.',
      sidebarSwitch: 'Sidebar',
      sidebarSwitchDesc: 'On by default (sidebar shown). Turning it off disables the WebView2 sidebar, saving ~900MB RAM per window and removing side black bars. Recommended off for 50+ batch windows.',
      autoGrantApkPermission: 'Auto-grant APK Permissions',
      autoGrantApkPermissionDesc: 'When enabled, all runtime permissions are automatically granted during APK installation (equivalent to pm install -g). When disabled, permissions must be manually granted inside the cloud machine.',
      projectionNotes: 'Notes',
      projectionNote1: 'Requires a discrete GPU or integrated graphics',
      projectionNote2: 'Ensure the graphics driver is correctly installed and up to date; a faulty driver may cause display issues',
      projectionNote3: 'Computers without a GPU will automatically use software decoding; no need to disable manually',
      projectionNote4: 'If you see flickering, green screens, or garbled visuals, try disabling to switch to software decoding',
      projectionNote5: 'Software decoding has better compatibility but higher CPU usage',
      projectionNote6: 'Changes take effect on the next projection',
      projectionSettingsSaved: 'Projection settings saved. Takes effect on next projection.',
      projectionSettingsSaveFailed: 'Failed to save projection settings',
      switching: 'Switching...',
      running: 'Running',
      backupCount: '{count} Backups',
      empty: 'Empty',
      booting: 'Booting...',
      shutdownClickBackup: 'Shutdown | Click to switch cloud machine',
      pleaseRenewInstance: 'Please renew instance',
    ...
    backup: {
      ...
      importBtn: 'Import',
      powerOnAfterImport: 'Power On',
      powerOnAfterImportTip: 'Power on after import; a running machine in the slot will be stopped first',
      index: 'Index',
  ...
  <ul style="margin: 0; padding-left: 20px;">
    ...
    image: {
      ...
      createFromLocal: 'Create from Local Image',
      createFromDevice: 'Create from Device Image',
      imageName: 'Image Name',
      imagePath: 'Image Path',
      imageURL: 'Image URL',
      size: 'Size',
      createTime: 'Create Time',
      refreshLocalImages: 'Refresh Local Images',
      refreshDeviceImages: 'Refresh Device Images',
      noLocalCacheImages: 'No locally cached images',
      noDeviceImages: 'No device images',
  ...
  <ul style="padding-left: 20px; color: #606266; margin-bottom: 0;">
    ...
    extension: {
      ...
      mytAgent: 'MYT Agent',
      mytAgentDesc: 'Manage your cloud phone devices via AI conversation',
      mytAgentSdkRequired: 'Required API version',
      mytAgentSdkCurrent: 'Current API version',
      mytAgentSdkNotMet: 'SDK version requirement not met (needs ≥ 177)',
      deviceAuthRequired: 'Device authentication required',
      devicePasswordPlaceholder: 'Please enter the device password',
      mytAgentGuideIntro: 'MYT Agent allows you to talk to your cloud phone devices in natural language, with AI automatically executing the corresponding actions.',
      mytAgentGuideReq: 'Requirement: device SDK version must be ≥ 165',
      mytAgentGuideStep1: 'Ensure the device SDK version is ≥ 165 (visible in the firmware version column of the device list)',
      mytAgentGuideStep2: 'Click "Install" to automatically download and install MYT Agent on the device',
      mytAgentGuideStep3: 'After installation, interact with the device through the conversation panel',
      tunnel: 'Tunnel',
    ...
    aiAssistant: {
      ...
      clearHistoryConfirm: 'Are you sure you want to clear the current conversation history? This cannot be undone.',
      continueFailed: 'Failed to continue the conversation.',
      ...
      editorPlaceholder: 'Enter your message, or drag/paste files here (Shift+Enter for a new line)',
      fetchModelFailed: 'Failed to fetch model list.',
      ...
      italic: 'Italic',
      llmStartFailed: 'LLM service failed to start.',
      llmStartSuccess: 'LLM service started.',
      llmStopFailed: 'LLM service failed to stop.',
      llmStopSuccess: 'LLM service stopped.',
      loadModelFailed: 'Failed to load model.',
      modelAlreadyRunning: 'This model is already running.',
      modelStartSuccess: 'Model started.',
      newChatStarted: 'New conversation started.',
      notImgVideo: 'Not an image or video file.',
      orderedList: 'Ordered List',
      pastedFiles: 'Pasted files',
      regenerateFailed: 'Failed to regenerate.',
      restoredDefault: 'Default settings restored.',
      saveFailed: 'Save failed.',
      selectDeviceAndModel: 'Select a device and model.',
      selectDeviceFirst: 'Please select a device first.',
    ...
    rpaAgent: {
      fetchModelFailed: 'Failed to fetch model list: ',
      loadContainerFailed: 'Failed to load container list: ',
      modelNotFound: 'Model not found',
      noLlmModel: 'No LLM model configured',
      stoppingOld: 'Stopping old instance...',
      startingWait: 'Starting, please wait...',
      modelReady: 'Model is ready',
      startFailed: 'Start failed: ',
      startTimeout: 'Start timed out',
      running: 'Running',
      starting: 'Starting',
      stopped: 'Stopped',
      settingsSaved: 'Settings saved',
      unconfiguredNodes: 'Devices without LLM model configured: ',
    }
  }
}
